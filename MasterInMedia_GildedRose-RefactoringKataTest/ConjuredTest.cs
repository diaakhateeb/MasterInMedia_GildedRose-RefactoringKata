...
namespace GildedRose_RefactoringKataTest
{
    ...
    public class ConjuredTest
    {
        ...
        {
            var itemsList = new List<Item> { new Item { Name = "Conjured Mana Cake", SellIn = 10, Quality = 20 } };
        ...
        {
            var itemsList = new List<Item> { new Item { Name = "Conjured Mana Cake", SellIn = 0, Quality = 20 } };
            var app = new GildedRose<Item>(itemsList);
        ...
        {
            var itemsList = new List<Item> { new Item { Name = "Conjured Mana Cake", SellIn = 0, Quality = 0 } };
            var app = new GildedRose<Item>(itemsList);
